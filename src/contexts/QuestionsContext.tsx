...
export function ContextsProvider({children} :QuestionsProviderProps) {
    ...
    const questionInitial = [
        ...
        {
            id: "2",
            question:"Eu tenho portas mas não sou uma casa, Tenho prateleiras mas não sou uma estante, Protejo o que você veste, mas não sou um cofre.",
            firstOption: "Closet",
            secondOption: "Maleta",
            thirdOption: "Guarda-roupa",
            fourthOption: "Armário de cozinha",
            questionCorrect: "3",
            rigthQuestion: undefined,
        },
        {
            ...
            firstOption: "Despensa",
            secondOption: "Armário de cozinha",
            thirdOption: "Freezer",
